...
<div class="rounded-lg border max-w-md mx-auto my-10 shadow-md bg-gray-800 text-white" data-v0-t="card">
  <form action="loginM.php" method="post">
    <div class="flex flex-col space-y-1.5 p-6">
      <h3 class="tracking-tight text-2xl text-center font-semibold">Medicos</h3>
    </div>
    <div class="p-6 space-y-4">
      <div class="space-y-2">
        ...
        >
          ...
          $conexion = coneccion();
          $query = "SELECT * FROM veris.usuarios WHERE Rol = 2";
    ...
    <div class="p-6 flex flex-col items-center space-y-4">
      ...
      <!-- Cambio: Mostrar mensaje de error -->
  ...
  </form> <!-- Cambio: Cerrar el formulario -->
</div>
</body>
</html>
